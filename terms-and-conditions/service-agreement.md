...
1. Use Products and Services in any manner that could disable, overburden, damage, or impair our Products and Services or interfere with any other party's use of our Products and Services, including their ability to engage in real time activities through our Products and Services.
2. Use any robot, spider, or other automatic device, process, or means to access our Products and Service for any purpose, including monitoring or copying any of the material.
3. Use any manual process to monitor or copy any of the material on our Products and Services or for any other unauthorized purpose without our prior written consent.
4. Use any device, software, or routine that interferes with the proper working of our Product or Service.
5. Introduce any viruses, trojan horses, worms, logic bombs, or other material which is malicious or technologically harmful.
6. Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts of our Service, the server on which our Product or Service is stored, or any server, computer, or database connected to our Products or Service.
